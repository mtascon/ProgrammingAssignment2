...
## 1. makeCacheMatrix fuction defines  matrix object and 
##    defines methods to set and get this matrix object 
##    and its inverse
## 2. cacheSolve function computes the inverse of the matrix 
##    returned by makeCacheMatrix
##    If the inverse has been calculated and the matrix has 
##    not changed, then the cached inverse is retrieved

## makeCacheMatrix. Function to create and store the matrix 
## object to cache the inverse of a matrix
...
## cacheSolve. Function to calculate the inverse of a matrix
